...
-----------------------
Usage:
  npx gmaps-scrape --url "<url>" [--download] [--output "<dir>"] [--limit <number>]
...
Example:
  npx gmaps-scrape --url "https://maps.app.goo.gl/dsyyKTns3o9JXENJ9" --download --limit 10
  `);
}
...
async function start() {
  ...
  try {
    const urls = await scrapePhotos(url, key, limit);
